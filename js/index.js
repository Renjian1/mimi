...
//热评
	let reping_btn=document.querySelectorAll(".reping_btn")
	let blue=document.querySelector(".blue")
	let blue1=document.querySelectorAll(".blue1")
	let jl=parseInt(getComputedStyle(blue,null).width)/2

	reping_btn[1].onclick=function(){
 		times++;
 		if(times>1){
 			times=1;
 		}
 		blue.style.transform='translateX('+(-jl*times)+'px)';

 	}
 	reping_btn[0].onclick=function(){
 		times--;
 		if(times<0){
 			times=0;
 		}
